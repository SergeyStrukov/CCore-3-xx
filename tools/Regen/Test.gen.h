...
struct Type_ISR
 {
  ...
  Type_ISR & setTo(Bar &bar,AddressType ind) { bar.set_ISR(ind,*this); return *this; }
...
struct Type_STAT
 {
  ...
  template <class Bar,class AddressType>
  Type_STAT & setTo(Bar &bar,AddressType ind) { bar.set_STAT(ind,*this); return *this; }
...
using Type_SCRAP = uint16 ;

/* type Type_PTR */

using Type_PTR = uint32 ;

/* type Type_TEMP */

using Type_TEMP = uint32 ;
