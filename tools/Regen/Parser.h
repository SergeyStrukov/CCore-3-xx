...
struct Reg_Field : ListBase<Reg_Field>
 {
  ...
  Reg_Field(const Atom &name_,Type type_,const Atom &number1_,const Atom &number2_,Atom *body_) // Type_number_to_number , Type_number_plus_number
   : name(name_),
     type(type_),
     number1(number1_),
     number2(number2_),
...
class Parser : NoCopy
 {
  ...
  public:
   ...
   using RegFieldNameCursor = Cursor<RegFieldNameProp> ;
   ...
   using RegFieldCursor = Cursor<RegFieldProp> ;
   ...
   using RegCursor = Cursor<RegProp> ;
   ...
   using BarRegCursor = Cursor<BarRegProp> ;
   ...
   using BarCursor = Cursor<BarProp> ;
