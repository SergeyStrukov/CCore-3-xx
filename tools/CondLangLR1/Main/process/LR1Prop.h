...
class LR1PropNonEmpty : public CmpComparable<LR1PropNonEmpty>
 {
   bool non_empty;
...
class LR1PropShiftSet : public CmpComparable<LR1PropShiftSet>
 {
  public:
...
class LR1PropValidSet : public CmpComparable<LR1PropValidSet>
 {
  public:
...
class LR1PropRuleSet : public CmpComparable<LR1PropRuleSet>
 {
  public:
