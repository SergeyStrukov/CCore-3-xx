...
class ClientEngine : public Funchor_nocopy , public PacketEndpointDevice::InboundProc , public PacketEndpointDevice::ConnectionProc
 {
   ...
   AttachmentHost<PacketEndpointDevice::ConnectionProc> host;

   using Hook = AttachmentHost<PacketEndpointDevice::ConnectionProc>::Hook ;
...
struct SessionExt : ExtBase<ServiceId,FunctionId_Session>
 {
  ...
  using OutputType = SessionOutput ;
...
class ClientDevice : public ObjBase , public Funchor
 {
  ...
  public:
   ...
   void attach(PacketEndpointDevice::ConnectionProc *proc) { engine.attach(proc); }
