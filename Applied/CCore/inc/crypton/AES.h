...
using AES128 = BlockCipher<AES<AES128Param> > ;

using AES192 = BlockCipher<AES<AES192Param> > ;

using AES256 = BlockCipher<AES<AES256Param> > ;

using AESInverse128 = BlockCipher<AESInverse<AES128Param> > ;

using AESInverse192 = BlockCipher<AESInverse<AES192Param> > ;

using AESInverse256 = BlockCipher<AESInverse<AES256Param> > ;
