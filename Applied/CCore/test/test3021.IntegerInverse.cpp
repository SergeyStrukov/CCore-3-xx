...
using namespace Private_3021;

/* Testit<3021> */

template<>
const char *const Testit<3021>::Name="Test3021 IntegerInverse";

template<>
bool Testit<3021>::Main()
 {
  Random gen;
