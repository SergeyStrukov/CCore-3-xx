...
struct Data128
 {
  using Cipher = Crypton::AES128 ;

  using InverseCipher = Crypton::AESInverse128 ;
...
struct Data192
 {
  using Cipher = Crypton::AES192 ;

  using InverseCipher = Crypton::AESInverse192 ;
...
struct Data256
 {
  using Cipher = Crypton::AES256 ;

  using InverseCipher = Crypton::AESInverse256 ;
...
template<>
const char *const Testit<3013>::Name="Test3013 AES";
