...
void test6()
 {
  ...
  uint64 N=1'000'000'000'001;

  for(ulen cnt=10'000'000; cnt ;cnt--,N+=2)
    {
     test(N,report);
    }
 }
...
using namespace Private_3024;

/* Testit<3024> */

template<>
const char *const Testit<3024>::Name="Test3024 APRTest";

template<>
bool Testit<3024>::Main()
 {
  DestroyPerTask dpt;
  Job::Init init;
