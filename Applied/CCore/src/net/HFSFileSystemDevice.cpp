...
Sys::AsyncFileState * FileSystemDevice::createState(const ObjHook &hook) noexcept
 {
...
void FileSystemDevice::getFileUpdateTime(Packet<uint8,Sys::AsyncFileSystem::CmpFileTimeExt> packet,StrLen path)
 {
  Packet<uint8,Sys::AsyncFileSystem::CmpFileTimeExt,GetFileUpdateTimeExt> packet2=packet.pushExt<GetFileUpdateTimeExt>();

  packet2.pushCompleteFunction(function_complete_getFileUpdateTime());

  dev->getFileUpdateTime(packet2.forgetExt<1>(),path);
 }
