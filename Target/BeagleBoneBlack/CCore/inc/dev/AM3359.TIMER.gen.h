...
struct Type_OCPConfig
 {
  ...
  Type_OCPConfig & setTo(Bar &bar,AddressType ind) { bar.set_OCPConfig(ind,*this); return *this; }
...
struct Type_RegMode
 {
  ...
  template <class Bar,class AddressType>
  Type_RegMode & setTo(Bar &bar,AddressType ind) { bar.set_RegMode(ind,*this); return *this; }
...
using Type_Counter = uint32 ;

/* type Type_Reload */

using Type_Reload = uint32 ;
...
struct Type_RegPost
 {
  ...
  template <class Bar,class AddressType>
  Type_RegPost & setTo(Bar &bar,AddressType ind) { bar.set_RegPost(ind,*this); return *this; }
...
struct Type_IntStatus
 {
  ...
  template <class Bar,class AddressType>
  Type_IntStatus & setTo(Bar &bar,AddressType ind) { bar.set_IntStatus(ind,*this); return *this; }
...
struct DMBar
 {
  ...
  template <class ... TT>
  explicit DMBar(TT && ... tt) : rw( std::forward<TT>(tt)... ) {}
