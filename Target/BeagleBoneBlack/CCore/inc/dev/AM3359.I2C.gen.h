...
struct Type_Config
 {
  ...
  template <class Bar,class AddressType>
  Type_Config & setTo(Bar &bar,AddressType ind) { bar.set_Config(ind,*this); return *this; }
...
struct Type_Prescale
 {
  ...
  template <class Bar,class AddressType>
  Type_Prescale & setTo(Bar &bar,AddressType ind) { bar.set_Prescale(ind,*this); return *this; }
...
struct Type_SCLLoTime
 {
  ...
  template <class Bar,class AddressType>
  Type_SCLLoTime & setTo(Bar &bar,AddressType ind) { bar.set_SCLLoTime(ind,*this); return *this; }
...
struct Type_SCLHiTime
 {
  ...
  template <class Bar,class AddressType>
  Type_SCLHiTime & setTo(Bar &bar,AddressType ind) { bar.set_SCLHiTime(ind,*this); return *this; }
...
struct Type_BufStatus
 {
  ...
  template <class Bar,class AddressType>
  Type_BufStatus & setTo(Bar &bar,AddressType ind) { bar.set_BufStatus(ind,*this); return *this; }
...
struct Type_BufControl
 {
  ...
  template <class Bar,class AddressType>
  Type_BufControl & setTo(Bar &bar,AddressType ind) { bar.set_BufControl(ind,*this); return *this; }
...
struct Type_SlaveAddress
 {
  ...
  template <class Bar,class AddressType>
  Type_SlaveAddress & setTo(Bar &bar,AddressType ind) { bar.set_SlaveAddress(ind,*this); return *this; }
...
struct Type_Counter
 {
  ...
  template <class Bar,class AddressType>
  Type_Counter & setTo(Bar &bar,AddressType ind) { bar.set_Counter(ind,*this); return *this; }
...
struct Type_Data
 {
  ...
  template <class Bar,class AddressType>
  Type_Data & setTo(Bar &bar,AddressType ind) { bar.set_Data(ind,*this); return *this; }
...
struct I2CBar
 {
  ...
  template <class ... TT>
  explicit I2CBar(TT && ... tt) : rw( std::forward<TT>(tt)... ) {}
