...
inline constexpr ulen ZeroToLen = 4_KByte ;
...
class BuildImage : NoCopy
 {
  ...
  private:
   ...
   static constexpr uint32 MinAddress   = 0x8100'0000 ;
   static constexpr uint32 LimAddress   = 0x8200'0000 ;
    ...
    {
     {
      ...
      if( argc!=3 )
        {
         Putobj(Con,"Usage: CCore-ELFtoUboot.exe <elf-file> <img-file>\n");
