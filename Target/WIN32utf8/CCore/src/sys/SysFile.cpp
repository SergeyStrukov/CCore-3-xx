  ...
  OpenFile(const WChar *file_name,FileOpenFlags oflags)
   {
    ...
    if( !set( Win32::CreateFileW(file_name,access_flags,share_flags,0,creation_options,file_flags,0) ) ) return;
...
void FileClose(FileMultiError &errout,Win32::handle_t handle,FileOpenFlags oflags,bool preserve_file)
 {
...
static_assert( Meta::IsSame<File::Type,Win32::handle_t> ,"CCore::Sys::File : bad Type");
...
static_assert( Meta::IsSame<AltFile::Type,Win32::handle_t> ,"CCore::Sys::AltFile : bad Type");
...
static_assert( Meta::IsSame<AltAsyncFile::Type,Win32::handle_t> ,"CCore::Sys::AltAsyncFile : bad Type");
