...
struct IntelAES128Func : IntelAESBase<AES<AES128Param>,IntelAES128Func>
 {
  ...
  static void Intel(const uint8 *round_key,uint8 *block) noexcept;
 };
...
using IntelAES128 = BlockCipher<IntelAES128Func> ;

using IntelAES192 = BlockCipher<IntelAES192Func> ;

using IntelAES256 = BlockCipher<IntelAES256Func> ;

using IntelAESInverse128 = BlockCipher<IntelAESInverse128Func> ;

using IntelAESInverse192 = BlockCipher<IntelAESInverse192Func> ;

using IntelAESInverse256 = BlockCipher<IntelAESInverse256Func> ;
