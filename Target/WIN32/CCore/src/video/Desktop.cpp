...
class WindowBitmap : NoCopy
 {
  ...
  public:
   ...
   explicit WindowBitmap(Point size_)
    : size(size_)
    {
   ...
   class WindowClass : NoCopy
    {
     ...
     public:
      ...
      WindowClass() : atom(0),error(Sys::NoError),hIcon(0),hIconSm(0) {}
...
WindowsHost::WindowClass WindowsHost::WindowClassObject CCORE_INITPRI_3 ;
