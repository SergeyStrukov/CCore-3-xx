  ...
  if( wdir )
    {
     ...
     ulen len=Win64::GetFullPathNameW(dir.getPtr(),MaxPathLen+1,temp,0);
...
ErrorType ProcessSetup::create(Win64::handle_t &handle) noexcept
 {
  ...
  Win64::flags_t flags=Win64::UnicodeEnvironment;
  ...
  if( Win64::CreateProcessW(0,cmdline.getPtr(),0,0,false,flags,envblock.getPtr(),wdir,&info,&pinfo) )
    {
