...
StrLen IndexConvert::ToString(int code)
 {
  switch( code )
    {
     case Error_NoBlock : return "No opened text block"_c;
...
auto IndexConvert::noFormat() const -> TagErrorId
 {
  if( fmt_b ) return Error_HasFmt;
  if( fmt_i ) return Error_HasFmt;
  if( fmt_u ) return Error_HasFmt;
...
auto IndexConvert::setFmt(bool &flag) -> TagErrorId
 {
  if( notOpened() ) return Error_NoBlock;
...
auto IndexConvert::clearFmt(bool &flag) -> TagErrorId
 {
  if( !flag ) return Error_NoFmt;
...
bool IndexConvert::TestSpace(StrLen str)
 {
  for(char ch : str ) if( !CharIsSpace(ch) ) return false;
...
StrLen IndexConvert::getFmt() const
 {
  return Range(fmt);
 }

auto IndexConvert::openText(BlockType bt,const String &kind) -> TagErrorId
 {
  if( block==NoBlock )
    {
     block=bt;
...
auto IndexConvert::closeText(BlockType bt) -> TagErrorId
 {
  if( block==bt )
    {
     block=NoBlock;
...
IndexConvert::IndexConvert(PrintBase &out,const PageParam &param)
 : book(out,param)
 {
 }

IndexConvert::~IndexConvert()
 {
 }

 // title

void IndexConvert::setTitle(String str)
 {
  book.setTitle(str);
 }
...
void IndexConvert::setId(String id)
 {
  book.setId(id);
 }
...
auto IndexConvert::frame(String str) -> TagErrorId
 {
  if( notOpened() && !TestSpace(Range(str)) ) return Error_NoBlock;
...
auto IndexConvert::tagH1() -> TagErrorId
 {
  return openText(Block_H1,"h1"_str);
 }

auto IndexConvert::tagH1end() -> TagErrorId
 {
  return closeText(Block_H1);
 }

auto IndexConvert::tagH2() -> TagErrorId
 {
  return openText(Block_H2,"h2"_str);
 }

auto IndexConvert::tagH2end() -> TagErrorId
 {
  return closeText(Block_H2);
 }

auto IndexConvert::tagH3() -> TagErrorId
 {
  return openText(Block_H3,"h3"_str);
 }

auto IndexConvert::tagH3end() -> TagErrorId
 {
  return closeText(Block_H3);
 }

auto IndexConvert::tagH4() -> TagErrorId
 {
  return openText(Block_H4,"h4"_str);
 }

auto IndexConvert::tagH4end() -> TagErrorId
 {
  return closeText(Block_H4);
 }

auto IndexConvert::tagH5() -> TagErrorId
 {
  return openText(Block_H5,"h5"_str);
 }

auto IndexConvert::tagH5end() -> TagErrorId
 {
  return closeText(Block_H5);
 }

auto IndexConvert::tagP() -> TagErrorId
 {
  return openText(Block_P,"text"_str);
 }

auto IndexConvert::tagP(String tclass) -> TagErrorId
 {
  return openText(Block_P,"text_"_str+tclass);
 }

auto IndexConvert::tagPend() -> TagErrorId
 {
  return closeText(Block_P);
 }

auto IndexConvert::tagPRE() -> TagErrorId
 {
  if( block==NoBlock )
    {
     block=Block_PRE;
...
auto IndexConvert::tagPREend() -> TagErrorId
 {
  if( block==Block_PRE )
    {
     block=NoBlock;
...
auto IndexConvert::tagB() -> TagErrorId
 {
  return setFmt(fmt_b);
 }

auto IndexConvert::tagBend() -> TagErrorId
 {
  return clearFmt(fmt_b);
 }

auto IndexConvert::tagI() -> TagErrorId
 {
  return setFmt(fmt_i);
 }

auto IndexConvert::tagIend() -> TagErrorId
 {
  return clearFmt(fmt_i);
 }

auto IndexConvert::tagU() -> TagErrorId
 {
  return setFmt(fmt_u);
 }

auto IndexConvert::tagUend() -> TagErrorId
 {
  return clearFmt(fmt_u);
 }

auto IndexConvert::tagSUB() -> TagErrorId
 {
  return setFmt(fmt_sub);
 }

auto IndexConvert::tagSUBend() -> TagErrorId
 {
  return clearFmt(fmt_sub);
 }

auto IndexConvert::tagSUP() -> TagErrorId
 {
  return setFmt(fmt_sup);
 }

auto IndexConvert::tagSUPend() -> TagErrorId
 {
  return clearFmt(fmt_sup);
 }

auto IndexConvert::tagSPAN(String sclass) -> TagErrorId
 {
  spanclass=sclass;
...
auto IndexConvert::tagSPANend() -> TagErrorId
 {
  return clearFmt(fmt_span);
 }
...
auto IndexConvert::tagA(String url) -> TagErrorId
 {
  book.setLink(url);
...
auto IndexConvert::tagA(String,String) -> TagErrorId
 {
  return setFmt(fmt_a);
 }

auto IndexConvert::tagAend() -> TagErrorId
 {
  book.clearLink();
...
auto IndexConvert::tagOL() -> TagErrorId
 {
  if( block==NoBlock )
    {
     block=Block_OL;
...
auto IndexConvert::tagOLend() -> TagErrorId
 {
  if( item ) return Error_ItemNotClosed;
...
auto IndexConvert::tagUL() -> TagErrorId
 {
  if( block==NoBlock )
    {
     block=Block_UL;
...
auto IndexConvert::tagULend() -> TagErrorId
 {
  if( item ) return Error_ItemNotClosed;
...
auto IndexConvert::tagLI() -> TagErrorId
 {
  if( inList() && !item )
    {
     item=true;
...
auto IndexConvert::tagLIend() -> TagErrorId
 {
  if( inList() && item )
    {
     item=false;
...
auto IndexConvert::tagImg(String file_name) -> TagErrorId
 {
  if( block ) return Error_InBlock;
...
auto IndexConvert::complete() -> TagErrorId
 {
  if( block ) return Error_InBlock;
