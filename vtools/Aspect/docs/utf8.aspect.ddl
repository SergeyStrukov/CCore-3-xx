...
Dir Dir88=
  {
   ...
   },
   {
    ...
    { 'Shape.Button.h' , Ignore },
    { 'Window.Button.h' , Ignore },
    { 'Shape.Check.h' , Ignore },
    { 'Window.Check.h' , Ignore },
    { 'Shape.Contour.h' , Ignore },
    { 'Window.Decor.h' , Ignore },
    { 'Shape.DragFrame.h' , Ignore },
    { 'Window.DragFrame.h' , Ignore },
    { 'Shape.FixedFrame.h' , Ignore },
    { 'Shape.FrameBase.h' , Ignore },
    { 'Shape.Info.h' , Ignore },
    { 'Window.Info.h' , Ignore },
    { 'Shape.Label.h' , Ignore },
    ...
    { 'Shape.Scroll.h' , Ignore },
    { 'Window.Scroll.h' , Ignore },
    { 'Shape.ScrollList.h' , Ignore },
    { 'Window.ScrollList.h' , Ignore },
    { 'Shape.SimpleTextList.h' , Ignore },
    { 'Window.SimpleTextList.h' , Ignore },
    { 'Shape.Spinor.h' , Ignore },
    { 'Window.Spinor.h' , Ignore },
    { 'Shape.Split.h' , Ignore },
    { 'Window.Split.h' , Ignore },
    { 'Shape.Switch.h' , Ignore },
    { 'Shape.Text.h' , Ignore },
    { 'Window.Text.h' , Ignore },
    { 'Shape.TextLine.h' , Ignore },
...
Dir Dir87=
  {
   ...
   },
   {
    ...
    { 'Picture.cpp' , Ignore },
    { 'PrintDDL.cpp' , Ignore },
    { 'ProgressScale.cpp' , Ignore },
    { 'RefVal.cpp' , Ignore },
    { 'ShapeLib.cpp' , Ignore },
    { 'SmoothAlgo.cpp' , Ignore },
...
Dir Dir90=
  {
   ...
   },
   {
    ...
    { 'Shape.Button.cpp' , Ignore },
    { 'Window.Button.cpp' , Ignore },
    { 'Shape.Check.cpp' , Ignore },
    ...
    { 'Shape.Radio.cpp' , Ignore },
    { 'Window.Radio.cpp' , Ignore },
    { 'Shape.Scroll.cpp' , Ignore },
    { 'Window.Scroll.cpp' , Ignore },
    { 'Shape.ScrollList.cpp' , Ignore },
    { 'Window.ScrollList.cpp' , Ignore },
    { 'Shape.SimpleTextList.cpp' , Ignore },
    { 'Window.SimpleTextList.cpp' , Ignore },
    { 'Shape.Spinor.cpp' , Ignore },
    { 'Window.Spinor.cpp' , Ignore },
    { 'Shape.Split.cpp' , Ignore },
    { 'Window.Split.cpp' , Ignore },
    { 'Shape.Switch.cpp' , Ignore },
    { 'Shape.Text.cpp' , Ignore },
    { 'Window.Text.cpp' , Ignore },
    { 'Shape.TextLine.cpp' , Ignore },
