...
using namespace Private_5012;

/* Testit<5012> */

template<>
const char *const Testit<5012>::Name="Test5012 TimedTrigger";

template<>
bool Testit<5012>::Main()
 {
  Event stop_event;
