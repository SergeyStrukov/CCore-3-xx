...
using namespace Private_5007;

/* Testit<5007> */

template<>
const char *const Testit<5007>::Name="Test5007 MultiSem";

template<>
bool Testit<5007>::Main()
 {
  {
   Data<Take> data;
