...
class Test : NoCopy
 {
  ...
  public:
   ...
   void post_signal1(int a) { msig.try_post<10,int>(a); }
   ...
   void post_first_signal1(int a) { msig.try_post_first<10,int>(a); }
...
using namespace Private_2050;

/* Testit<2050> */

template<>
const char *const Testit<2050>::Name="Test2050 MultiSignal";

template<>
bool Testit<2050>::Main()
 {
  Queue queue;
