...
void testSNode1()
 {
  ...
  using Algo = SLink<SNode>::LinearAlgo<&SNode::link> ;
...
void testSNode2()
 {
  ...
  using Algo = SLink<SNode>::CircularAlgo<&SNode::link> ;
...
void testDNode1()
 {
  ...
  using Algo = DLink<DNode>::LinearAlgo<&DNode::link> ;
...
void testDNode2()
 {
  ...
  using Algo = DLink<DNode>::CircularAlgo<&DNode::link> ;
...
using namespace Private_2027;

/* Testit<2027> */

template<>
const char *const Testit<2027>::Name="Test2027 List";

template<>
bool Testit<2027>::Main()
 {
  testSNode1();
  testSNode2();
  testDNode1();
