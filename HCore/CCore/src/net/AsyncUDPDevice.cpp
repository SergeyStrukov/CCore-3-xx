...
PacketFormat AsyncUDPEndpointDevice::getOutboundFormat() const
 {
...
ulen AsyncUDPEndpointDevice::getMaxInboundLen() const
 {
...
StrLen AsyncUDPMultipointDevice::toText(XPoint point,PtrLen<char> buf) const
 {
  PrintBuf out(buf);
...
PacketFormat AsyncUDPMultipointDevice::getOutboundFormat() const
 {
  return dev.getOutboundFormat();
 }
...
ulen AsyncUDPMultipointDevice::getMaxInboundLen() const
 {
  return dev.getMaxInboundLen();
 }
