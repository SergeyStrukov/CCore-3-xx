...
class AsyncFileProcessor : NoCopy
 {
  public:
   ...
   using Async = Sys::AltAsyncFile::Async ;
  ...
  private:
   ...
   using SlotTop = SLink<Slot>::LinearAlgo<&Slot::link>::Top ;
...
class AsyncFileDevice : public ObjBase , public Sys::AsyncFileDevice
 {
   class Engine : public NoCopy
    {
      using Work = AsyncFileProcessor::Work ;
      using Async = AsyncFileProcessor::Async ;
